...
Questo repository contiene l'implementazione del controllore energy-aware, basato sull’algoritmo **EAMO (Energy-Aware Microservices Orchestrator)**, per la tesi di laurea magistrale in ingegenria informatica.
